...
@Entity('beneficio_cecan') // Nombre de la tabla en la base de datos
export class CecanBeneficio {
  ...
  @ManyToOne(() => CecanBeneficiario, beneficiario => beneficiario.beneficios)
